...
try:
    ...
    data = [
        ("Stretch-Wool Flannel Blazer", 
         ...
         "Polo Ralph Lauren", 699, True, False, True, True, True, "New", "Loose fit"),
        ...
        ("George F - Blazers",
         ...
         "Matinique", 299, True, False, True, True, True, "", ""),
        ...
        ("FLEX DOBBY SF SHIRT", 
         ...
         "", "Tommy Hilfiger", 199, True, False, True, True, True, "", ""),
        ...
        ("MAlas - Business Trousers",
         ...
         "Matinique", 111, True, False, True, True, True, "50% OFF", "Regular Fit"),
        ...
        ("B NSW CLUB SSNL SHORT SET",
         ...
         "", "", "Nike", 699, True, False, True, True, True, "", "")
    ]

    # Insert data into the Products table
    insert_query = """
        INSERT INTO Products (
            name, img1, img2, img3, img4, img5, brand, price, xs, s, m, l, xl, tag, type
        ) VALUES (
